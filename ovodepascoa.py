# Dicionário com preços dos ovos e recheios
precos = {
    "pequeno": 7.80,
    "medio": 12.90,
    "grande": 23.95,
...
# Entrada do usuário para o tamanho e sabor do ovo
...
# Cálculo do preço baseado nos adicionais selecionados
preco_adicionais = sum(precos[adicional] for adicional in adicionais)

# Entrada do usuário para o tipo de serviço
